...
@IFMLLoadingPlugin.Name(ServerPropertiesLAN.MODID)
public class ServerPropertiesLAN extends DummyModContainer implements IFMLLoadingPlugin
{
    ...
    public static final String VERSION = "2.65-fix";
    public static final String UPDATEURL = "https://raw.githubusercontent.com/DawningW/MinecraftForge-Mods-ServerPropertiesLAN/master/update.json";
    ...
    public ServerPropertiesLAN()
    {
        ...
        md.version = VERSION;
        md.name = MODNAME;
        md.authorList = Lists.newArrayList("Jaideep Singh Heer", "QingChenW");
        md.description = "MeoW.!";
        md.credits = "By Jaideep Singh Heer. Fixed by QingChenW";
        md.logoFile = "logo.png";
        md.screenshots = new String[]{"scr1.jpg", "Untitled.jpg", "logo2.png"};
        md.url = "https://github.com/DawningW/MinecraftForge-Mods-ServerPropertiesLAN";
    }
    ...
    public void onServerStarting(FMLServerStartingEvent event) {
        ...
        ServerProperties.comment = "Minecraft Server Properties for LAN."
         ...
         + System.getProperty("line.separator") + "set port=25565"
        ...
        server.setOnlineMode(ServerProperties.getBooleanProperty("online-mode", false));
        ...
        server.setMOTD(ServerProperties.getStringProperty("motd", server.getServerOwner() + "'s " + server.getWorldName()));
    ...
    public void onPlayerConnect(EntityJoinWorldEvent event) {
        ...
        if (whiteListFirstRun) {
            System.out.println("--------------ID=" + event.entity.getUniqueID() + "\tNAME=" + event.entity.getName());
            server.getConfigurationManager().addWhitelistedPlayer(server.getConfigurationManager().getAllProfiles()[0]);
            server.getConfigurationManager().setWhiteListEnabled(true);
            try {
                server.getConfigurationManager().getWhitelistedPlayers().writeChanges();
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
